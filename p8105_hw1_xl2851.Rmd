...
```
Logical and factor vector can be converted into numeric vector while character vector cannot. This can explain why character vector can not take the mean.
...
The proportion of cases for which x+y>1 is `r mean(pull(hw11_df,C))`
